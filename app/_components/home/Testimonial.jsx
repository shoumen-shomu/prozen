...
const Testimonial = () => {
  ...
  return (
    <section className="py-20">
      <div className="max-w-330 mx-auto bg-[#F8F9F9] rounded-[20px] p-10 lg:p-20 flex flex-col lg:flex-row gap-10 lg:gap-20 items-center relative">
        ...
        <div className="items-center">
          ...
          >
            ...
            <div className="">
              ...
              <p className="font-jakarta font-extrabold text-[24px] text-[#063231] leading-9 mb-10">
